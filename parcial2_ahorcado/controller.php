...
{
    case 0: // titulo
        $levels = array('0' => 'Juego Facil: 10 vidas',
                        '1' => 'Juego Medio: 5 vidas',
                        '2' => 'Juego Dificil: 3 vidas');
    ...
    case 1: // inicio
        $lines = file('diccionario.txt');
        $word = $lines[rand(0, count($lines) - 1)];
	$word = substr($word, 0, strlen($word) -2); // Si no se está utilizando el diccionario predeterminado, es posible que deba cambiar el "-2" por "-1"
